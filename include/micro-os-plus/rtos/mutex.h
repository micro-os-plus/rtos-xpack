...
#pragma GCC diagnostic ignored "-Wpadded"
    ...
    public:
       ...
       * @ingroup micro-os-plus-rtos-mutex
       */
      static constexpr count_t max_count_value = 0xFFFF;
      ...
      public:
         ...
         */
        thread::priority_t priority_ceiling = thread::priority::highest;

        /**
         * @brief Attribute with the mutex protocol.
         */
        protocol_t protocol = protocol::default_;

        /**
         * @brief Attribute with the mutex robustness.
         */
        robustness_t robustness = robustness::stalled;

        /**
         * @brief Attribute with the mutex type.
         */
        type_t type = type::default_;

        /**
         * @brief Attribute with the mutex maximum recursive count.
         */
        count_t max_count = max_count_value;
