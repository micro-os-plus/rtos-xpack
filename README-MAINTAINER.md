...
- name the post like: **µOS++ rtos v2.0.0 released**
...
- `npm dist-tag add @micro-os-plus/micro-test-plus@2.0.0 latest`
- `npm dist-tag ls @@micro-os-plus/micro-test-plus`
...
- paste the release name like **µOS++ rtos v2.0.0 released**
